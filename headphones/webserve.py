...
class WebInterface(object):
    ...
    def config(self):
        ...
        config = {
                    ...
                    "preproc_script" : checked(headphones.PREPROC_SCRIPT),
                    "preproc_script_file" : headphones.PREPROC_SCRIPT_FILE,
    ...
    def configUpdate(self, http_host='0.0.0.0', http_username=None, http_port=8181, http_password=None, launch_browser=0, api_enabled=0, api_key=None,
        ...
        preferred_words=None, required_words=None, ignored_words=None, preferred_quality=0, preferred_bitrate=None, detect_bitrate=0, preproc_script=0, preproc_script_file=None, move_files=0, torrentblackhole_dir=None, download_torrent_dir=None,
        ...
        headphones.PREPROC_SCRIPT = preproc_script
        headphones.PREPROC_SCRIPT_FILE = preproc_script_file
