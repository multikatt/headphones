...
PREPROC_SCRIPT = False
PREPROC_SCRIPT_FILE = None
MOVE_FILES = False
RENAME_FILES = False
CLEANUP_FILES = False
KEEP_NFO = False
...
def initialize():
    ...
    with INIT_LOCK:
        ...
        global __INITIALIZED__, FULL_PATH, PROG_DIR, VERBOSE, QUIET, DAEMON, SYS_PLATFORM, DATA_DIR, CONFIG_FILE, CFG, CONFIG_VERSION, LOG_DIR, CACHE_DIR, \
                ...
                LOSSLESS_DESTINATION_DIR, PREFERRED_QUALITY, PREFERRED_BITRATE, DETECT_BITRATE, ADD_ARTISTS, CORRECT_METADATA, PREPROC_SCRIPT, PREPROC_SCRIPT_FILE, MOVE_FILES, \
        ...
        PREPROC_SCRIPT = bool(check_setting_int(CFG, 'General', 'preproc_script', 0))
        PREPROC_SCRIPT_FILE = check_setting_str(CFG, 'General', 'preproc_script_file', '')
...
def config_write():
    ...
    new_config['General']['preproc_script'] = int(PREPROC_SCRIPT)
    new_config['General']['preproc_script_file'] = PREPROC_SCRIPT_FILE
